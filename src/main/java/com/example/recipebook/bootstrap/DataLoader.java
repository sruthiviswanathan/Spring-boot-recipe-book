...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> asRequiredUomOptional = unitOfMeasureRepository.findByDescription("as required");
        if (!asRequiredUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }
        ...
        UnitOfMeasure asRequiredUom = asRequiredUomOptional.get();
